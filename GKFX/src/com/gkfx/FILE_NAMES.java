...
//	public static String DEAL_RECORD 		= "Raw Report-Y.htm";
	...
	public static String IB_GROUP			= "IB-Group.xlsx";
	public static String GROUP_CLIENT		= "Accounts-Group.xlsx";
	public static String GROUP_CONDITION	= "Group-Condition.xlsx";
	
	public static String FINAL_REPORT		= "final_report.xlsx";
}
